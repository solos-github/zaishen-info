...
Global $iToast_Style = 2 ; $SS_CENTER
...
; Example........; Yes
;=====================================================================================================================
Func _Toast_Show($vIcon, $sTitle, $sMessage, $iDelay = 0, $fWait = True, $fRaw = True)
	...
	Local $iToast_Width_max = 600
	Local $iToast_Width_min = 350

	; Check for icon
	Local $iIcon_Style = 0
	Local $iIcon_Reduction = 100
	...
	Local $iMax_Label_Width = $iToast_Width_max  - $iIcon_Reduction
	If $fRaw = True Then $iMax_Label_Width = 0

	; Get message label size
	Local $aLabel_Pos = _StringSize($sMessage, 12.0, 100, Default, $sToast_Font_Name, $iMax_Label_Width)
	...
	Local $iLine_Height = $aLabel_Pos[1] +5

	; Set label size
	Local $iLabelwidth = $aLabel_Pos[2] +50
	Local $iLabelheight = $aLabel_Pos[3] +150
	...
	If $iIcon_Reduction Then
		Switch StringLower(StringRight($sImg, 3))
			Case "bmp", "jpg", "gif"
				GUICtrlCreatePic($sImg, 5, 5 + $iTitle_Height, 82, 82)
			Case "png"
